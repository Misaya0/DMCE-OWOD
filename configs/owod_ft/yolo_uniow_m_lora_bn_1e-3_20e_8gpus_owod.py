...
model = dict(
    ...
    freeze_prompt=False,
    use_SPGA=use_SPGA,
    embedding_path=f'embeddings/uniow-m/{_base_.owod_dataset.lower()}_t{_base_.owod_task}.npy',  # known embeddings
    unknown_embedding_path='embeddings/uniow-m/object.npy',  # unknown embeddings
    anchor_embedding_path='embeddings/uniow-m/object_tuned.npy',  # anchor embeddings
