...
# load_from = 'work_dirs/yolo_uniow_s_lora_object_ft_bn_1e-4_3e_8gpus_owod/best_lvis_AR@100_epoch_5.pth'
...
custom_hooks = [
    ...
    # # 正交化Hook - 在epoch 0, 5, 10, 15进行更新
    # dict(type='OrthogonalUpdateHook',
    #      update_epochs=[0, 5, 10, 15],
    #      num_known_classes=num_training_classes - 2)
]
