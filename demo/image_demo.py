...
def parse_args():
    ...
    parser.add_argument(
        'text',
        default='person,bicycle,car,motorcycle,airplane,bus,train,truck,boat,traffic light,fire hydrant,stop sign,parking meter,bench,bird,cat,dog,horse,sheep,cow,unknown',
        help=
...
if __name__ == '__main__':
    args = parse_args()
    args.text = 'person,bicycle,car,motorcycle,airplane,bus,train,truck,boat,traffic light,fire hydrant,stop sign,parking meter,bench,bird,cat,dog,horse,sheep,cow,unknown'
    # load config
