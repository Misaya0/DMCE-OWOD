...
class YOLOv10WorldHeadModule(YOLOv10HeadModule):
    ...
    def __init__(self,
        ...
        # self.freeze_one2one = False
        # self.freeze_one2many = False
...
class YOLOv10WorldHead(YOLOv10Head):
    ...
    def loss(self, img_feats: Tuple[Tensor], txt_feats: Tensor,
        ...
        if isinstance(batch_data_samples, list):
            ...
            losses,tmp_labels = self.loss_by_feat([one2many_loss_inputs, one2one_loss_inputs])

        return losses,tmp_labels
    ...
    def loss_by_feat(self, all2one) -> dict:
        ...
        losses, tmp_label = self.one2many_loss_by_feat(*one2many_loss_inputs)
        losses_one, tmp_label_one = self.one2one_loss_by_feat(*one2one_loss_inputs)
        losses.update(losses_one)
        # tmp_labels = tmp_label
        return losses, tmp_label_one