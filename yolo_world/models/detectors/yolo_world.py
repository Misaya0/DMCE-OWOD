...
class MultiScaleAdapter(nn.Module):
    def __init__(self, in_channels_list, reduction=4):
        super().__init__()
    ...
    def forward(self, feats):  # feats 是一个 list/tuple, 包含3个尺度特征
...
class YOLOWorldDetector(YOLODetector):
    ...
    def __init__(self,
        ...
        # self.img_adapter = MultiScaleAdapter(in_channels_list=[128, 256, 512])
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        img_feats, txt_feats = self.extract_feat(batch_inputs,
                                                 batch_data_samples)
        losses,tmp_labels = self.bbox_head.loss(img_feats, txt_feats, batch_data_samples)
        return losses
