...
class HuggingCLIPLanguageBackbone(BaseModule):
    ...
    def __init__(self,
        ...
        self.training_use_lora = training_use_lora
        ...
        if training_use_lora:
            ...
            self.model.add_adapter(lora_config, "text_encoder_lora")
    ...
    def _freeze_modules(self):
        ...
        if len(self.frozen_modules) == 0 or self.training_use_lora:
            # not freeze or lora training (auto freeze)
            return
